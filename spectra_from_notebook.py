...
w_filt_1st[0,:,:,:] = data0_20.variables['w_on_p_r'][0,:,:,:]
w_filt_1st[1,:,:,:] = data1_20.variables['w_on_p_r'][0,:,:,:]
w_filt_1st[2,:,:,:] = data2_20.variables['w_on_p_r'][0,:,:,:]
w_filt_1st[3,:,:,:] = data3_20.variables['w_on_p_r'][0,:,:,:]
w_filt_1st[4,:,:,:] = data4_20.variables['w_on_p_r'][0,:,:,:]
w_filt_1st[5,:,:,:] = data5_20.variables['w_on_p_r'][0,:,:,:]
...
w_filt_2nd[0,:,:,:] = data0_2nd.variables['w_on_p_r'][0,:,:,:]
w_filt_2nd[1,:,:,:] = data1_2nd.variables['w_on_p_r'][0,:,:,:]
w_filt_2nd[2,:,:,:] = data2_2nd.variables['w_on_p_r'][0,:,:,:]
w_filt_2nd[3,:,:,:] = data3_2nd.variables['w_on_p_r'][0,:,:,:]
w_filt_2nd[4,:,:,:] = data4_2nd.variables['w_on_p_r'][0,:,:,:]
w_filt_2nd[5,:,:,:] = data5_2nd.variables['w_on_p_r'][0,:,:,:]
...
#print("sigma 25")
w_filt_1st_0, w_kpo_filt1g1 = f.spectra_2d(w_filt_1st[1,:,:,:], dx, dy, options_spec)
#print("sigma 50")
w_filt_1st_1, w_kpo_filt2g1 = f.spectra_2d(w_filt_1st[2,:,:,:], dx, dy, options_spec)
#print("w_filt_1st_sigma 100")
w_filt_1st_2, w_kpo_filt3g1 = f.spectra_2d(w_filt_1st[3,:,:,:], dx, dy, options_spec)
#print("sigma 200")
w_filt_1st_3, w_kpo_filt4g1 = f.spectra_2d(w_filt_1st[4,:,:,:], dx, dy, options_spec)
#print("sigma 400")
w_filt_1st_4, w_kpo_filt5g1 = f.spectra_2d(w_filt_1st[5,:,:,:], dx, dy, options_spec)
#print("sigma 522")
w_filt_1st_5, w_kpo_filt6g1 = f.spectra_2d(w_filt_1st[6,:,:,:], dx, dy, options_spec)
#print("sigma 522")


w_filt_2nd_0, w_kpo_filt1g2 = f.spectra_2d(w_filt_2nd[1,:,:,:], dx, dy, options_spec)
#print("sigma 50")
w_filt_2nd_1, w_kpo_filt2g2 = f.spectra_2d(w_filt_2nd[2,:,:,:], dx, dy, options_spec)
#print("w_filt_1st_sigma 100")
w_filt_2nd_2, w_kpo_filt3g2 = f.spectra_2d(w_filt_2nd[3,:,:,:], dx, dy, options_spec)
#print("sigma 200")
w_filt_2nd_3, w_kpo_filt4g2 = f.spectra_2d(w_filt_2nd[4,:,:,:], dx, dy, options_spec)
#print("sigma 400")
w_filt_2nd_4, w_kpo_filt5g2 = f.spectra_2d(w_filt_2nd[5,:,:,:], dx, dy, options_spec)
#print("sigma 522")
w_filt_2nd_5, w_kpo_filt6g2 = f.spectra_2d(w_filt_2nd[6,:,:,:], dx, dy, options_spec)
