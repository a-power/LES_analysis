    ...
    ########### need to fix this, fo now only do one 2nd filt at a time
            ...
            for i, field_in in enumerate(fields):
                ...
                mydataset = homedir + myfile + \
                            str(f'{field_dir[i]}_{j}_{name_2_gauss}.nc') #_running_mean_filter_rm00.nc')
                mydir_contour = dir_contour + f'{j}_gaussian_filter_ga0{name_2_gauss}.nc' #_running_mean_filter_rm00.nc'
