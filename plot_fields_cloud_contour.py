...
apf.plotfield(plotdir_in, start_end=x_axis_start_end, **plot_var_fields_options, **Cs_options)
apf.plotfield(plotdir_in, start_end=x_axis_start_end, **plot_var_fields_options, **Cth_options)
apf.plotfield(plotdir_in, start_end=x_axis_start_end, **plot_var_fields_options, **Cqt_options)
