...
ARM_z_set = np.arange(-5, 4405, 10)
#z_ML = 10 #z_ML_calc
ARM_z_ML_bottom = 20

ARM_z_cl_r_t_list = [ [87, 110], [102, 150], [115, 200], [130, 230] ] #z_cl_range_calc
ARM_z_ml_r_t_list = [ [20, 75], [20, 80], [20, 85], [20, 90] ] #z_ml_range_calc

ARM_set_time = ['18000', '25200', '32400', '39600']
...
BOMEX_zn_set = np.arange(0, 3020, 20)
BOMEX_z_set = np.arange(-10, 3010, 20)
BOMEX_z_ML = 490 # the w'th' 1D MONC prof suggests 440m

BOMEX_z_cl_r_Bomex = [49, 73]
BOMEX_z_ml_r_Bomex = [10, 22]

BOMEX_set_time = ['14400']
