...
Cs_2D_prof_t0, Cs_2D_field_t0, times = t_dy.Cs(data_2D, dx=20, dx_hat=40, ingrid = mygrid, t_in=0)
...
Cs_4D_prof_t0, Cs_4D_field_t0, times = t_dy.Cs(data_4D, dx=20, dx_hat=80, ingrid = mygrid, t_in=0)
