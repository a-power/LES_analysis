...
dataset_name32 = path20f+file20+'Cs_32D.nc'
dataset_name64 = path20f+file20+'Cs_64D.nc'
...
Cs_prof_sq_16d = None        #free memory
Cs_prof_16d = None           #free memory
LM_prof_16d = None           #free memory
MM_prof_16d = None           #free memory
Cs_sq_field_16d = None       #free memory
LM_field_16d = None          #free memory
MM_field_16d = None          #free memory
L_ij_16 = None
M_ij_16 = None
...
Cs_prof_sq_32d, Cs_prof_32d, LM_prof_32d, MM_prof_32d, Cs_sq_field_32d, LM_field_32d, MM_field_32d, L_ij_32, M_ij_32 = \
...
save_field(ds_in32, Cs_prof_sq_32d)
save_field(ds_in32, Cs_prof_32d)
save_field(ds_in32, LM_prof_32d)
save_field(ds_in32, MM_prof_32d)
save_field(ds_in32, LM_field_32d)
save_field(ds_in32, MM_field_32d)
save_field(ds_in32, L_ij_32)
save_field(ds_in32, M_ij_32)
save_field(ds_in32, Cs_sq_field_32d)

Cs_prof_sq_32d = None        #free memory
Cs_prof_32d = None           #free memory
LM_prof_32d = None           #free memory
MM_prof_32d = None           #free memory
Cs_sq_field_32d = None       #free memory
LM_field_32d = None          #free memory
MM_field_32d = None          #free memory
L_ij_32 = None
M_ij_32 = None
...
Cs_prof_sq_64d, Cs_prof_64d, LM_prof_64d, MM_prof_64d, Cs_sq_field_64d, LM_field_64d, MM_field_64d, L_ij_64, M_ij_64 = \
...
save_field(ds_in64, Cs_prof_sq_64d)
save_field(ds_in64, Cs_prof_64d)
save_field(ds_in64, LM_prof_64d)
save_field(ds_in64, MM_prof_64d)
save_field(ds_in64, LM_field_64d)
save_field(ds_in64, MM_field_64d)
save_field(ds_in64, L_ij_64)
save_field(ds_in64, M_ij_64)
save_field(ds_in64, Cs_sq_field_64d)

Cs_prof_sq_64d = None        #free memory
Cs_prof_64d = None           #free memory
LM_prof_64d = None           #free memory
MM_prof_64d = None           #free memory
Cs_sq_field_64d = None       #free memory
LM_field_64d = None          #free memory
MM_field_64d = None          #free memory
L_ij_64 = None
M_ij_64 = None
