...
if plot_choice == 'HCs_HCsSA':
    ...
    for i in range(6):
        ...
        if i == 0:
            ...
            plt.plot(list_timestamps, CB_mean_height_ts[i, :], colour_cycle[5], linestyle=':', marker='^')
            plt.plot(list_timestamps, CT_mean_height_ts[i, :], colour_cycle[5], linestyle=':', marker='^',
