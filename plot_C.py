...
# plt.ylabel("z (m)")
# plt.xlim(0, 1)
# plt.savefig(plotdir+'Cs_beta_prof.png', pad_inches=0, bbox_inches='tight')
#
# plt.figure(figsize=(6,7))
# plt.plot(beta_th, z)
...
# plt.ylabel("z (m)")
# plt.xlim(0, 1)
# plt.savefig(plotdir+'Cth_beta_prof.png', pad_inches=0, bbox_inches='tight')
#
# plt.figure(figsize=(6,7))
# plt.plot(beta_q, z)
...
# plt.ylabel("z (m)")
# plt.xlim(0.19, 0.21)
# plt.savefig(plotdir+'Cq_beta_prof.png', pad_inches=0, bbox_inches='tight')
...
# plt.ylabel("z (m)")
# #plt.xlim(0, 1)
# plt.savefig(plotdir+'all_beta_profs.png', pad_inches=0, bbox_inches='tight')
# plt.close()
...
# plt.ylabel("z/z$_{ML}$")
# plt.xlim(0, 1)
# plt.savefig(plotdir+'Cs_beta_prof_scaled.png', pad_inches=0, bbox_inches='tight')
#
# plt.figure(figsize=(6,7))
...
# plt.ylabel("z/z$_{ML}$")
# plt.xlim(0, 1)
# plt.savefig(plotdir+'Cth_beta_prof_scaled.png', pad_inches=0, bbox_inches='tight')
#
# plt.figure(figsize=(6,7))
...
# plt.ylabel("z/z$_{ML}$")
# plt.xlim(0.19, 0.21)
# plt.savefig(plotdir+'Cq_beta_prof_scaled.png', pad_inches=0, bbox_inches='tight')
...
plt.ylabel("z/z$_{ML}$")
plt.xlim(0, 1)
plt.savefig(plotdir+'all_beta_profs_scaled.png', pad_inches=0, bbox_inches='tight')
plt.close()
...
# plt.legend(fontsize=12, loc='upper right')
# #plt.xlim(1, 3)
# plt.savefig(plotdir+'Cs_prof.png', pad_inches=0, bbox_inches='tight')
...
plt.legend(fontsize=12, loc='upper right')
#plt.xlim(1, 3)
plt.savefig(plotdir+'Cs_prof_scaled.png', pad_inches=0, bbox_inches='tight')
plt.close()
...
# plt.legend(fontsize=12, loc='upper right')
# #plt.xlim(1, 3)
# plt.savefig(plotdir+'Cqt_prof.png', pad_inches=0, bbox_inches='tight')
...
plt.legend(fontsize=12, loc='upper right')
#plt.xlim(1, 3)
plt.savefig(plotdir+'Cqt_prof_scaled.png', pad_inches=0, bbox_inches='tight')
plt.close()
...
# plt.legend(fontsize=12, loc='upper right')
# #plt.xlim(1, 3)
# plt.savefig(plotdir+'Cth_prof.png', pad_inches=0, bbox_inches='tight')
...
plt.legend(fontsize=12, loc='upper right')
#plt.xlim(1, 3)
plt.savefig(plotdir+'Cth_prof_scaled.png', pad_inches=0, bbox_inches='tight')
plt.close
...
plt.legend(fontsize=12, loc='upper right')
#plt.xlim(1, 3)
plt.savefig(plotdir+'l_mix_no_stan_w_MONC_scaled.png', pad_inches=0, bbox_inches='tight')
plt.close()
...
# plt.legend(fontsize=12, loc='upper right')
# #plt.xlim(1, 3)
# plt.savefig(plotdir+'l_th_w_MONC.png', pad_inches=0, bbox_inches='tight')
...
plt.legend(fontsize=12, loc='upper right')
#plt.xlim(1, 3)
plt.savefig(plotdir+'l_th_no_stan_w_MONC_scaled.png', pad_inches=0, bbox_inches='tight')
plt.close()
...
# plt.legend(fontsize=12, loc='upper right')
# #plt.xlim(1, 3)
# plt.savefig(plotdir+'l_qt_w_MONC.png', pad_inches=0, bbox_inches='tight')
...
plt.legend(fontsize=12, loc='upper right')
#plt.xlim(1, 3)
plt.savefig(plotdir+'l_qt_no_stan_w_MONC_scaled.png', pad_inches=0, bbox_inches='tight')
plt.close()
...
# #plt.xlim(-3, 7)
# plt.savefig(plotdir+'Pr_th_prof.png', pad_inches=0, bbox_inches='tight')
# plt.close()
...
plt.xlim(-3, 7)
plt.savefig(plotdir+'Pr_th_prof_scaled1.png', pad_inches=0, bbox_inches='tight')
plt.close()
...
plt.vlines(0.7, 0, 3020/z_i, 'k', linestyles='dashed', label='')
plt.xlim(-3, 31)
plt.savefig(plotdir+'Pr_th_prof_scaled2.png', pad_inches=0, bbox_inches='tight')
plt.close()
...
# plt.vlines(0.7, 0, 3020, 'k', linestyles='dashed', label='')
# #plt.xlim(-3, 7)
# plt.savefig(plotdir+'Pr_qt_prof.png', pad_inches=0, bbox_inches='tight')
# plt.close()
...
plt.vlines(0.7, 0, 3020/z_i, 'k', linestyles='dashed', label='')
plt.xlim(-3, 7)
plt.savefig(plotdir+'Pr_qt_prof_scaled.png', pad_inches=0, bbox_inches='tight')
plt.close()
...
# plt.vlines(0.7, 0, 3020, 'k', linestyles='dashed', label='')
# plt.xlim(-3, 7)
# plt.savefig(plotdir+'Pr_all_prof.png', pad_inches=0, bbox_inches='tight')
#
# plt.figure(figsize=(6,7))
...
# plt.vlines(0.7, 0, 3020/z_i, 'k', linestyles='dashed', label='')
# plt.xlim(-3, 7)
# plt.savefig(plotdir+'Pr_all_prof_scaled.png', pad_inches=0, bbox_inches='tight')
