...
Cs_list = [Cs_beta1, Cs_beta2, Cs_beta3, Cs_beta4, Cs_beta5]
Cth_list = [Cth_beta1, Cth_beta2, Cth_beta3, Cth_beta4, Cth_beta5]
Cq_list = [Cq_beta1, Cq_beta2, Cq_beta3, Cq_beta4, Cq_beta5]
...
plt.plot(Delta, cal_max_Cs(Cs_list, z_ml_r), 'k', label = '$C_{s \\beta}$')
plt.plot(Delta, cal_max_Cs(Cs_list, z_cl_r), 'k-.')
plt.plot(Delta, cal_max_Cs(Cth_list, z_ml_r), 'r', label = '$C_{\\theta \\beta}$')
plt.plot(Delta, cal_max_Cs(Cth_list, z_cl_r), 'r-.')
plt.plot(Delta, cal_max_Cs(Cq_list, z_ml_r), 'b', label = '$C_{qt \\beta}$')
plt.plot(Delta, cal_max_Cs(Cq_list, z_cl_r), 'b-.')
plt.xlabel('Filter scale $\\Delta$ (m)', fontsize=16)
plt.ylabel('Scale Dependent Smagorinsky Parameter', fontsize=16)
plt.legend(fontsize=12, loc='best')
plt.savefig(plotdir+'C_max_prof_ML_vs_CL.png', pad_inches=0)
plt.close()

plt.figure(figsize=(8,5))
plt.plot(Delta, cal_max_Cs(Cs_list, z_ml_r)*Delta, 'k', label = '$l_{mix \\beta}$')
plt.plot(Delta, cal_max_Cs(Cs_list, z_cl_r)*Delta, 'k-.')
plt.plot(Delta, cal_max_Cs(Cth_list, z_ml_r)*Delta, 'r', label = '$l_{\\theta \\beta}$')
plt.plot(Delta, cal_max_Cs(Cth_list, z_cl_r)*Delta, 'r-.')
plt.plot(Delta, cal_max_Cs(Cq_list, z_ml_r)*Delta, 'b', label = '$l_{qt \\beta}$')
plt.plot(Delta, cal_max_Cs(Cq_list, z_cl_r)*Delta, 'b-.')
plt.plot(Delta, 0.23*Delta, 'g-', label = 'Standard $l_{mix}$')
plt.xlabel('Filter scale $\\Delta$ (m)', fontsize=16)
plt.ylabel('Scale Dependent Mixing Length (m)', fontsize=16)
plt.ylim(-0.5, 45)
plt.legend(fontsize=12, loc='best')
...
#
# plt.figure(figsize=(8,5))
# plt.plot(Delta, cal_max_Cs(Cs_cloud_list, z_cl_r), 'k', label = '$C_{s}$')
# plt.plot(Delta, cal_max_Cs(Cs_env_list, z_cl_r), 'k-.')
# plt.plot(Delta, cal_max_Cs(Cth_cloud_list, z_cl_r), 'r', label = '$C_{\\theta}$')
# plt.plot(Delta, cal_max_Cs(Cth_env_list, z_cl_r), 'r-.')
# plt.plot(Delta, cal_max_Cs(Cqt_cloud_list, z_cl_r), 'b', label = '$C_{qt}$')
...
#
# plt.figure(figsize=(8,5))
# plt.plot(Delta, cal_max_Cs(Cs_cloud_list, z_cl_r)*Delta, 'k', label = '$l_{mix}$')
# plt.plot(Delta, cal_max_Cs(Cs_env_list, z_cl_r)*Delta, 'k-.')
# plt.plot(Delta, cal_max_Cs(Cth_cloud_list, z_cl_r)*Delta, 'r', label = '$l_{\\theta}$')
# plt.plot(Delta, cal_max_Cs(Cth_env_list, z_cl_r)*Delta, 'r-.')
# plt.plot(Delta, cal_max_Cs(Cqt_cloud_list, z_cl_r)*Delta, 'b', label = '$l_{qt}$')
