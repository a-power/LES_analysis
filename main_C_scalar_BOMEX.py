...
dataset_name2 = path20f+file20+f'C{scalar}_2D.nc'
dataset_name4 = path20f+file20+f'C{scalar}_4D.nc'


########################################################################

C_q_sq_prof_2D, C_q_prof_2D, HR_prof_2D, RR_prof_2D, C_q_sq_field_2D, HR_field_2D, RR_field_2D, Hj_2D, Rj_2D = \
    t_dy.C_scalar(scalar, data_2D, dx=20, dx_hat=40, ingrid=mygrid)
...
C_q_sq_prof_4D, C_q_prof_4D, HR_prof_4D, RR_prof_4D, C_q_sq_field_4D, HR_field_4D, RR_field_4D, Hj_4D, Rj_4D = \
    t_dy.C_scalar(scalar, data_2D, dx=20, dx_hat=80, ingrid=mygrid)
