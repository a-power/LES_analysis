...
for i, delta_in in enumerate(deltas):
    ...
    Cqt_cloud_prof, Cqt_env_prof, Cqt_cloud_field, Cqt_env_field, \
    HR_qt_cloud_av, HR_qt_env_av, RR_qt_cloud_av, RR_qt_env_av, \
    HjRj_qt_cloud, HjRj_qt_env, RjRj_qt_cloud, RjRj_qt_env = clo.get_masked_fields_HR(delta = delta_in, res_count = i, **options)
