...
plt.figure(figsize=(6,8))
plt.plot(beta_q, z)
plt.xlabel('$\\beta_q_t$', fontsize=14)
plt.ylabel("z (m)")
#plt.xlim(0, 2)
...
plt.plot(beta_q, z, label='$\\beta_q_t$')
...
plt.xlabel('$Pr_{q_t}$', fontsize=14)
plt.ylabel("z (m)")
plt.legend(fontsize=16, loc='upper right')
plt.vlines(0.7, 0, 3020, 'k', linestyles='dashed', label='')
#plt.xlim(1, 3)
...
plt.plot(Pr_q_beta, z, label = '$Pr_{q_t} \\Delta = 20$m', color = 'tab:blue', linestyle='dashdot')
plt.plot(Pr_q_2D, z, label = '$Pr_{q_t} \\Delta = 40$m', color = 'tab:orange', linestyle='dashdot')
plt.plot(Pr_q_4D, z, label = '$Pr_{q_t} \\Delta = 80$m', color = 'tab:green', linestyle='dashdot')
...
plt.plot(Pr_q_beta, z/z_i, label = '$Pr_{q_t} \\Delta = 20$m', color = 'tab:blue', linestyle='dashdot')
plt.plot(Pr_q_2D, z/z_i, label = '$Pr_{q_t} \\Delta = 40$m', color = 'tab:orange', linestyle='dashdot')
plt.plot(Pr_q_4D, z/z_i, label = '$Pr_{q_t} \\Delta = 80$m', color = 'tab:green', linestyle='dashdot')
plt.xlabel('$Pr$', fontsize=14)
plt.ylabel("z/$_{ML}$")
plt.legend(fontsize=16, loc='upper right')
plt.vlines(0.7, 0, 3020, 'k', linestyles='dashed', label='')
