...
plt.ylabel("z (m)")
plt.xlim(0, 1)
plt.savefig(plotdir+'Cs_beta_prof.png', bbox='tight', pad_inches=0)
...
plt.ylabel("z (m)")
plt.xlim(0, 1)
plt.savefig(plotdir+'Cth_beta_prof.png', bbox='tight', pad_inches=0)
...
plt.ylabel("z (m)")
plt.xlim(0.19, 0.21)
plt.savefig(plotdir+'Cq_beta_prof.png', bbox='tight', pad_inches=0)
...
plt.ylabel("z (m)")
plt.xlim(0, 1)
plt.savefig(plotdir+'beta_profs.png', bbox='tight', pad_inches=0)
...
plt.ylabel("z/z$_{ML}$")
plt.xlim(0, 1)
plt.savefig(plotdir+'Cs_beta_prof_scaled.png', bbox='tight', pad_inches=0)
...
plt.ylabel("z/z$_{ML}$")
plt.xlim(0, 1)
plt.savefig(plotdir+'Cth_beta_prof_scaled.png', bbox='tight', pad_inches=0)
...
plt.ylabel("z/z$_{ML}$")
plt.xlim(0.19, 0.21)
plt.savefig(plotdir+'Cq_beta_prof_scaled.png', bbox='tight', pad_inches=0)
...
plt.ylabel("z/z$_{ML}$")
plt.xlim(0, 1)
plt.savefig(plotdir+'beta_profs_scaled.png', bbox='tight', pad_inches=0)
...
plt.legend(fontsize=16, loc='upper right')
#plt.xlim(1, 3)
plt.savefig(plotdir+'Cs_prof.png', bbox='tight', pad_inches=0)
...
plt.legend(fontsize=16, loc='upper right')
#plt.xlim(1, 3)
plt.savefig(plotdir+'Cs_prof_scaled.png', bbox='tight', pad_inches=0)
...
plt.legend(fontsize=16, loc='upper right')
#plt.xlim(1, 3)
plt.savefig(plotdir+'Cqt_prof.png', bbox='tight', pad_inches=0)
...
plt.legend(fontsize=16, loc='upper right')
#plt.xlim(1, 3)
plt.savefig(plotdir+'Cqt_prof_scaled.png', bbox='tight', pad_inches=0)
...
plt.legend(fontsize=16, loc='upper right')
#plt.xlim(1, 3)
plt.savefig(plotdir+'Cth_prof.png', bbox='tight', pad_inches=0)
...
plt.legend(fontsize=16, loc='upper right')
#plt.xlim(1, 3)
plt.savefig(plotdir+'Cth_prof_scaled.png', bbox='tight', pad_inches=0)
...
plt.legend(fontsize=16, loc='upper right')
#plt.xlim(1, 3)
plt.savefig(plotdir+'l_mix_w_MONC.png', bbox='tight', pad_inches=0)
...
plt.legend(fontsize=16, loc='upper right')
#plt.xlim(1, 3)
plt.savefig(plotdir+'l_mix_w_MONC_scaled.png', bbox='tight', pad_inches=0)
...
plt.xlim(-3, 7)
plt.savefig(plotdir+'Pr_th_prof.png', bbox='tight', pad_inches=0)
...
plt.xlim(-3, 7)
plt.savefig(plotdir+'Pr_th_prof_scaled.png', bbox='tight', pad_inches=0)
...
plt.vlines(0.7, 0, 3020, 'k', linestyles='dashed', label='')
plt.xlim(-3, 7)
plt.savefig(plotdir+'Pr_qt_prof.png', bbox='tight', pad_inches=0)
...
plt.vlines(0.7, 0, 3020/z_i, 'k', linestyles='dashed', label='')
plt.xlim(-3, 7)
plt.savefig(plotdir+'Pr_qt_prof_scaled.png', bbox='tight', pad_inches=0)
...
plt.vlines(0.7, 0, 3020, 'k', linestyles='dashed', label='')
plt.xlim(-3, 7)
plt.savefig(plotdir+'Pr_all_prof.png', bbox='tight', pad_inches=0)
...
plt.vlines(0.7, 0, 3020/z_i, 'k', linestyles='dashed', label='')
plt.xlim(-3, 7)
plt.savefig(plotdir+'Pr_all_prof_scaled.png', bbox='tight', pad_inches=0)
