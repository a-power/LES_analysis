...
plotdir = '/gws/nopw/j04/paracon_rdg/users/apower/20m_gauss_dyn/plots/C_profiles/cloud_vs_env/'
...
plt.xlabel('$C_{\\theta}$ in Cloud', fontsize=16)
plt.ylabel("z/z$_{ML}$", fontsize=16)
plt.legend(fontsize=12, loc='upper right')
#plt.xlim(1, 3)
plt.ylim(-0.25, 6.25)
...
plt.xlabel('$C_{\\theta}$ in env', fontsize=16)
plt.ylabel("z/z$_{ML}$", fontsize=16)
plt.legend(fontsize=12, loc='upper right')
#plt.xlim(1, 3)
...
plt.figure(figsize=(6,7))
plt.plot(Cs_cloud_beta_sq*(20)**2, z/z_i, color ='tab:blue', markersize = 10, label = '$\\Delta = 20$m')
plt.plot(Cs_sq_cloud_2*(40)**2, z/z_i, color ='tab:orange', markersize = 10, label = '$\\Delta = 40$m')
plt.plot(Cs_sq_cloud_4*(80)**2, z/z_i, color ='tab:green', markersize = 10, label = '$\\Delta = 80$m')
plt.plot(Cs_sq_cloud_8*(160)**2, z/z_i, color ='tab:red', markersize = 10, label = '$\\Delta = 160$m')
plt.plot(Cs_sq_cloud_16*(320)**2, z/z_i, color ='tab:purple', markersize = 10, label = '$\\Delta = 320$m')
plt.plot(Cs_sq_cloud_32*(640)**2, z/z_i, color ='tab:grey', markersize = 10, label = '$\\Delta = 640$m')
plt.plot(Cs_sq_cloud_64*(1280)**2, z/z_i, color ='tab:pink', markersize = 10, label = '$\\Delta = 1280$m')
...
plt.xlabel('$l_{mix}^2$ in cloud', fontsize=16)
plt.ylabel("z/z$_{ML}$", fontsize=16)
plt.legend(fontsize=12, loc='upper right')
#plt.xlim(1, 3)
plt.ylim(-0.25, 6.25)
plt.savefig(plotdir+'l_mix_sq_cloud_no_stan_w_MONC_scaled.png', pad_inches=0)
plt.close()
...
plt.figure(figsize=(6,7))
plt.plot(Cs_env_beta_sq*(20)**2, z/z_i, color ='tab:blue', markersize = 10, label = '$\\Delta = 20$m')
plt.plot(Cs_sq_env_2*(40)**2, z/z_i, color ='tab:orange', markersize = 10, label = '$\\Delta = 40$m')
plt.plot(Cs_sq_env_4*(80)**2, z/z_i, color ='tab:green', markersize = 10, label = '$\\Delta = 80$m')
plt.plot(Cs_sq_env_8*(160)**2, z/z_i, color ='tab:red', markersize = 10, label = '$\\Delta = 160$m')
plt.plot(Cs_sq_env_16*(320)**2, z/z_i, color ='tab:purple', markersize = 10, label = '$\\Delta = 320$m')
plt.plot(Cs_sq_env_32*(640)**2, z/z_i, color ='tab:grey', markersize = 10, label = '$\\Delta = 640$m')
plt.plot(Cs_sq_env_64*(1280)**2, z/z_i, color ='tab:pink', markersize = 10, label = '$\\Delta = 1280$m')
# plt.plot(monc_l_20, z/z_i, color ='tab:blue')
# plt.plot(monc_l_40, z/z_i, color ='tab:orange')
# plt.plot(monc_l_80, z/z_i, color ='tab:green')
# plt.plot(monc_l_160, z/z_i, color ='tab:red')
...
# plt.plot(monc_l_640, z/z_i, color ='tab:grey')
# plt.plot(monc_l_1280, z/z_i, color ='tab:pink')
plt.xlabel('$l_{mix}^2$ in env', fontsize=16)
plt.ylabel("z/z$_{ML}$", fontsize=16)
plt.legend(fontsize=12, loc='upper right')
#plt.xlim(1, 3)
plt.savefig(plotdir+'l_mix_sq_env_no_stan_w_MONC_scaled.png', pad_inches=0)
plt.close()
...
plt.figure(figsize=(6,7))
plt.plot(Cth_cloud_beta_sq*(20)**2, z/z_i, color ='tab:blue', markersize = 10, label = '$\\Delta = 20$m')
plt.plot(Cth_sq_cloud_2*(40)**2, z/z_i, color ='tab:orange', markersize = 10, label = '$\\Delta = 40$m')
plt.plot(Cth_sq_cloud_4*(80)**2, z/z_i, color ='tab:green', markersize = 10, label = '$\\Delta = 80$m')
plt.plot(Cth_sq_cloud_8*(160)**2, z/z_i, color ='tab:red', markersize = 10, label = '$\\Delta = 160$m')
plt.plot(Cth_sq_cloud_16*(320)**2, z/z_i, color ='tab:purple', markersize = 10, label = '$\\Delta = 320$m')
plt.plot(Cth_sq_cloud_32*(640)**2, z/z_i, color ='tab:grey', markersize = 10, label = '$\\Delta = 640$m')
plt.plot(Cth_sq_cloud_64*(1280)**2, z/z_i, color ='tab:pink', markersize = 10, label = '$\\Delta = 1280$m')
...
plt.xlabel('$l_{\\theta}^2$ in cloud', fontsize=16)
plt.ylabel("z/z$_{ML}$", fontsize=16)
plt.legend(fontsize=12, loc='upper right')
#plt.xlim(1, 3)
plt.ylim(-0.25, 6.25)
plt.savefig(plotdir+'l_th_sq_cloud_no_stan_w_MONC_scaled.png', pad_inches=0)
plt.close()
...
plt.figure(figsize=(6,7))
plt.plot(Cth_env_beta_sq*(20)**2, z/z_i, color ='tab:blue', markersize = 10, label = '$\\Delta = 20$m')
plt.plot(Cth_sq_env_2*(40)**2, z/z_i, color ='tab:orange', markersize = 10, label = '$\\Delta = 40$m')
plt.plot(Cth_sq_env_4*(80)**2, z/z_i, color ='tab:green', markersize = 10, label = '$\\Delta = 80$m')
plt.plot(Cth_sq_env_8*(160)**2, z/z_i, color ='tab:red', markersize = 10, label = '$\\Delta = 160$m')
plt.plot(Cth_sq_env_16*(320)**2, z/z_i, color ='tab:purple', markersize = 10, label = '$\\Delta = 320$m')
plt.plot(Cth_sq_env_32*(640)**2, z/z_i, color ='tab:grey', markersize = 10, label = '$\\Delta = 640$m')
plt.plot(Cth_sq_env_64*(1280)**2, z/z_i, color ='tab:pink', markersize = 10, label = '$\\Delta = 1280$m')
...
plt.xlabel('$l_{\\theta}^2$ in env', fontsize=16)
plt.ylabel("z/z$_{ML}$", fontsize=16)
plt.legend(fontsize=12, loc='upper right')
#plt.xlim(1, 3)
plt.savefig(plotdir+'l_th_sq_env_no_stan_w_MONC_scaled.png', pad_inches=0)
plt.close()
...
plt.figure(figsize=(6,7))
plt.plot(Cqt_cloud_beta_sq*(20)**2, z/z_i, color ='tab:blue', markersize = 10, label = '$\\Delta = 20$m')
plt.plot(Cqt_sq_cloud_2*(40)**2, z/z_i, color ='tab:orange', markersize = 10, label = '$\\Delta = 40$m')
plt.plot(Cqt_sq_cloud_4*(80)**2, z/z_i, color ='tab:green', markersize = 10, label = '$\\Delta = 80$m')
plt.plot(Cqt_sq_cloud_8*(160)**2, z/z_i, color ='tab:red', markersize = 10, label = '$\\Delta = 160$m')
plt.plot(Cqt_sq_cloud_16*(320)**2, z/z_i, color ='tab:purple', markersize = 10, label = '$\\Delta = 320$m')
plt.plot(Cqt_sq_cloud_32*(640)**2, z/z_i, color ='tab:grey', markersize = 10, label = '$\\Delta = 640$m')
plt.plot(Cqt_sq_cloud_64*(1280)**2, z/z_i, color ='tab:pink', markersize = 10, label = '$\\Delta = 1280$m')
...
plt.xlabel('$l_{qt}^2$ in cloud', fontsize=16)
plt.ylabel("z/z$_{ML}$", fontsize=16)
plt.legend(fontsize=12, loc='upper right')
#plt.xlim(1, 3)
plt.ylim(-0.25, 6.25)
plt.savefig(plotdir+'l_qt_sq_cloud_no_stan_w_MONC_scaled.png', pad_inches=0)
plt.close()
...
plt.figure(figsize=(6,7))
plt.plot(Cqt_env_beta_sq*(20)**2, z/z_i, color ='tab:blue', markersize = 10, label = '$\\Delta = 20$m')
plt.plot(Cqt_sq_env_2*(40)**2, z/z_i, color ='tab:orange', markersize = 10, label = '$\\Delta = 40$m')
plt.plot(Cqt_sq_env_4*(80)**2, z/z_i, color ='tab:green', markersize = 10, label = '$\\Delta = 80$m')
plt.plot(Cqt_sq_env_8*(160)**2, z/z_i, color ='tab:red', markersize = 10, label = '$\\Delta = 160$m')
plt.plot(Cqt_sq_env_16*(320)**2, z/z_i, color ='tab:purple', markersize = 10, label = '$\\Delta = 320$m')
plt.plot(Cqt_sq_env_32*(640)**2, z/z_i, color ='tab:grey', markersize = 10, label = '$\\Delta = 640$m')
plt.plot(Cqt_sq_env_64*(1280)**2, z/z_i, color ='tab:pink', markersize = 10, label = '$\\Delta = 1280$m')
...
plt.xlabel('$l_{qt}^2$ in env', fontsize=16)
plt.ylabel("z/z$_{ML}$", fontsize=16)
plt.legend(fontsize=12, loc='upper right')
#plt.xlim(1, 3)
plt.savefig(plotdir+'l_qt_sq_env_no_stan_w_MONC_scaled.png', pad_inches=0)
plt.close()
