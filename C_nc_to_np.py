...
if case=='BOMEX':
    ...
    if filt_num == 1:
        homedir = f'/work/scratch-pw3/apower/ARM/first_filt/LM/update/C_profs/diagnostics_3d_ts_{time}_C_cond_profs_'
        res = ['2D', '4D', '8D', '16D', '32D', '64D']
        #res = ['25_50', '50_100', '100_200']
    elif filt_num == 2:
        homedir = f'/work/scratch-pw3/apower/ARM/second_filt/LM/update/C_profs/diagnostics_3d_ts_{time}_C_cond_profs_'
        if beta == 0:
