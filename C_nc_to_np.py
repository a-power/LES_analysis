...
data_dir = f'/gws/nopw/j04/paracon_rdg/users/apower/LES_analysis/data/C_profs/{folder}/{case}/'
...
if case=='BOMEX':
    ...
    time = '14400'
    if filt_num == 1:
        homedir = f'/work/scratch-pw3/apower/BOMEX/first_filt/LM/{folder}/C_profs/BOMEX_m0020_g0800_all_14400_C_cond_profs_'
        res = ['20_40', '20_80', '20_160', '20_320', '20_640', '20_1280']
        #res = ['20_40', '40_80', '80_160', '160_320', '320_640', '640_1280']
    elif filt_num == 2:
        homedir = f'/work/scratch-pw3/apower/BOMEX/second_filt/LM/{folder}/C_profs/BOMEX_m0020_g0800_all_14400_C_cond_profs_'
        if beta == 0:
    ...
    if filt_num == 1:
        homedir = f'/work/scratch-pw3/apower/ARM/first_filt/LM/{folder}/C_profs/diagnostics_3d_ts_{time}_C_cond_profs_'
        res = ['2D', '4D', '8D', '16D', '32D', '64D']
        #res = ['25_50', '50_100', '100_200']
    elif filt_num == 2:
        homedir = f'/work/scratch-pw3/apower/ARM/second_filt/LM/{folder}/C_profs/diagnostics_3d_ts_{time}_C_cond_profs_'
        if beta == 0:
